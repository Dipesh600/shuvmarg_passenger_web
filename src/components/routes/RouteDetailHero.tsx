  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-20 text-left w-full max-w-[1600px] mx-auto pt-[120px] md:pt-[140px] px-4 md:px-18 pb-6">
          ...
          <div className="text-[#475569] text-base md:text-lg font-medium mb-6 max-w-3xl leading-relaxed">
